...
/rhel-9-for-x86_64-baseos-rpms=$repoLoc/rhel-9-for-x86_64-baseos-rpms \
/rhel-9-for-x86_64-appstream-rpms=$repoLoc/rhel-9-for-x86_64-appstream-rpms \
/codeready-builder-for-rhel-9-x86_64-rpms=$repoLoc/codeready-builder-for-rhel-9-x86_64-rpms
)
